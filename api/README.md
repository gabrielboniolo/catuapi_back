...
*Documentação interativa disponível em: http://127.0.0.1:5000/openapi*
...
Desenvolvido por **Gabriel Boniolo** como parte do MVP da disciplina de Desenvolvimento Full Stack Básico da pós-graduação de  **Engenharia de Software | PUC-Rio**.
